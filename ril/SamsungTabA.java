...
/**
 * RIL customization for Samsung Tab A devices
 *
 * {@hide}
 */
public class SamsungTabA extends RIL implements CommandsInterface {
    ...
    public SamsungTabA(Context context, int networkMode, int cdmaSubscription,Integer instanceId) {
